...
export const servicesData = {
  'residential-bin-cleaning': {
    ...
    seoDescription: 'Professional residential garbage bin cleaning and sanitization in Champaign-Urbana. Eliminate odors and bacteria with our deep cleaning process.',
    icon: 'Trash2'
  },
  'commercial-dumpsters': {
    ...
    seoTitle: 'Commercial Dumpster Cleaning & Sanitization | Funk Away GCS',
    seoDescription: 'Expert commercial dumpster cleaning for businesses in Central Illinois. Say goodbye to foul odors and bacteria. Custom contracts available.',
    icon: 'Trash2'
  },
  'power-washing': {
    title: 'Power Washing',
    ...
    seoTitle: 'Professional Power Washing Services | Funk Away GCS',
  ...
  'gutter-cleaning': {
    ...
    seoTitle: 'Professional Gutter Cleaning Services | Funk Away GCS',
    seoDescription: 'Protect your home from water damage with our expert gutter cleaning services. Serving Champaign-Urbana and Central Illinois.',
    icon: 'Home'
  },
  'window-cleaning': {
    ...
    seoTitle: 'Interior & Exterior Window Cleaning | Funk Away GCS',
    seoDescription: 'Let the light in with our professional window cleaning services. Streak-free results for the interior and exterior of your home.',
    icon: 'Home'
  },
  'patio-deck-cleaning': {
    ...
    seoTitle: 'Patio & Deck Cleaning and Staining | Funk Away GCS',
    seoDescription: 'Restore your deck or patio with expert cleaning, power washing, and staining services. Make your outdoor spaces beautiful again.',
    icon: 'Home'
  },
  ...
  'roof-solar-cleaning': {
    ...
    seoTitle: 'Roof & Solar Panel Cleaning Service | Funk Away GCS',
    seoDescription: 'Extend the life of your roof and maximize solar panel efficiency with our safe, professional soft washing and cleaning services.',
    icon: 'Home'
  }
};
